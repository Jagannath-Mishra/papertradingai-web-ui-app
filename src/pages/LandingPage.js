            ...
            <div class="app-wrap">
                ...
                <nav class="navbar navbar-expand-xl py-lg-3 lp-menu">
                    <div class="container py-2 rounded">
                        <a class="navbar-brand fw-bold  fs-3" href="/" title="Logo"><i class="fa fa-gg-circle fs-3 text-primary pe-2"></i>PaperTradingAI</a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <Link to="/login"><a href="http://pixelwibes.com/template/Stockon/html/dist/ui-elements/auth-signin.html" target="_blank" title="login" class="btn text-uppercase mx-sm-1 py-2">Login</a></Link>
                            <Link to="/register"><a href="http://pixelwibes.com/template/Stockon/html/dist/ui-elements/auth-signup.html" target="_blank" title="Register" class="btn btn-primary rounded text-uppercase py-2">Register</a></Link>
                            </form>
                        </div>
                    </div>
                </nav>
                            ...
                            <div class="row mb-5">
                                <div class="col-lg-4 col-md-6 col-12">
                                    <div class="d-flex align-items-center">
                                        <h4 class="mb-4 fw-bold "><i class="fa fa-gg-circle fs-3 text-primary pe-2"></i>PaperTradingAI</h4>
                                    </div>
