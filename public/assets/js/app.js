  ...
  if (comingsoon) {
    ...
    const interval = setInterval(() => {
      ...
      if (daysElement && hoursElement && minutesElement && secondsElement) {
        ...
        console.error("One or more countdown elements not found in the DOM.");
        clearInterval(interval); // Stop interval if elements are missing
      }
    }, second);
  } else {
    console.error("Coming soon section not found in the DOM.");
  }
});
